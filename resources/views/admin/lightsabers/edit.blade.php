...
<div class="container">
    ...
    <form action="{{route('lightsabers.update', $lightsaber)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Acolyte Eco Battle staff" value="{{old('name', $lightsaber->name)}}">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" name="price" id="price" aria-describedby="helpId" placeholder="99.99" value="{{old('price', $lightsaber->price)}}">
